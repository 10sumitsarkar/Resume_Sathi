...
export const metadata = {
  ...
  description:
    "Create a professional resume in minutes with ResumeSathi’s free resume builder using ATS-friendly templates and smart editing tools.",
  keywords: [
    "build resume instantly",
    "resume generator",
    "ATS resume",
    "resume templates",
  ],
