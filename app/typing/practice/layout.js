...
export default function PracticeLayout({ children }) {
  return <><TypingJsonLd name="ResumeSathi Free Typing Test" description="A free online typing practice tool with timed tests, word drills, quotes, code snippets, and custom text." path="/typing/practice" /><h1 className="visually-hidden">Free Typing Test and Practice</h1>{children}</>;
}
