...
export default function StatsLayout({ children }) {
  return <><TypingJsonLd name="ResumeSathi Typing Progress Tracker" description="A private browser-based dashboard for tracking typing speed, accuracy, practice streaks, and missed keys." path="/typing/stats" />{children}</>;
}
