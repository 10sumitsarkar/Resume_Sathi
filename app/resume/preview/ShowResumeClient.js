            ...
            <section className='show-resume-section pb-5 pb-md-0 mb-5 mb-md-0'>
                ...
                <div ref={sliderCustRef} className={`mob-customization-slider d-lg-none ${mobCustomizeSlider === 'open' ? 'open' : ''}`}>
                    ...
                    <div className="scroll-div">
                        ...
                        <div className={`each-collapse-div ${activeIndexes.includes(1) ? 'active' : ''}`}>
                            <button type='button' className='collapse-btn' onClick={() => toggleIndex(1)}>Layout Style</button>
                            <div className='collapse-content'>
                                <label><input type="radio" name='layoutStyleMob' checked={!customizeData?.layout_style || customizeData?.layout_style === 'all'} onChange={() => filterLayout('layout_style', 'all')} hidden /><div className='radio-btn'></div>All</label>
                                <label><input type="radio" name='layoutStyleMob' checked={customizeData?.layout_style === 'single-column'} onChange={() => filterLayout('layout_style', 'single-column')} hidden /><div className='radio-btn'></div>Single Column</label>
                                <label><input type="radio" name='layoutStyleMob' checked={customizeData?.layout_style === 'two-column'} onChange={() => filterLayout('layout_style', 'two-column')} hidden /><div className='radio-btn'></div>Two Column</label>
                            </div>
                        </div>
