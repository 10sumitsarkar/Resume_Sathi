...
export default function ResumeTemplate3({
  ...
  const Header = ({
    ...
    <div className="rt3_header">
      ...
      <div className="rt3_header_info">
        ...
        {jobTitle && (
          <p className="rt3_jobtitle resume-job-title">{jobTitle}</p>
        )}
        <ul className="rt3_contact_list">
          {(city || state) && (
            <li>
              <span className="rt3_icon">
                <IconLocation />
              </span>
  ...
  return (
    <div
      ...
      data-selected-resume="ResumeTemplate3"
              ...
              <div className="rt3_main">
                <div className="rt3_block">
                  ...
                  <p className="rt3_body_text resume-about-me">
                    Creative and detail-oriented UI/UX Designer with over 6
                    years of experience crafting user-friendly digital
                    experiences. Passionate about solving design problems
                    through empathy and innovative solutions.
                  </p>
                </div>
                  ...
                  {[
                    {
                      ...
                      date: "2019 – Present",
                      sub: "Remote",
                      desc: "Led a team of designers for a fintech product, improving user retention by 30%.",
                    },
                    {
                      title: "UX Designer",
                      ...
                      date: "2016 – 2019",
                      sub: "Austin, TX",
                      desc: "Designed mobile apps and web dashboards for health and e-commerce clients.",
                    },
                  ].map((e, i) => (
                  ...
                  {[
                    {
                      ...
                      sub: "University of Texas, Austin",
                      date: "2012 – 2016",
                    },
                    {
                      title: "Certified UX Specialist",
                      sub: "Nielsen Norman Group",
                      date: "2018",
                    },
                  ].map((e, i) => (
                    <div className="rt3_entry" key={i}>
                      ...
                      {skills.map((skill, i) => (
                        <li key={i}>
                          ...
                          <div className="rt3_bar">
                            <span
                              style={{
                                width: `${levelMap[skill.proficiency_level] || 70}%`,
                              }}
                            />
                          </div>
                        </li>
                  ...
                  <div className="rt3_block">
                    ...
                    {work_experiences.map((work, i) => (
                      <div className="rt3_entry" key={i}>
                        ...
                        <p className="rt3_entry_sub">
                          {work.location}
                          {work.employee_type ? ` • ${work.employee_type}` : ""}
                        </p>
                        {work.description && (
                          <p className="rt3_entry_desc">{work.description}</p>
                        )}
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="rt3_block">
                    ...
                    {certificates.map((cert, i) => (
                      <div className="rt3_entry" key={i}>
                        ...
                        {cert.description && (
                          <p className="rt3_entry_desc">{cert.description}</p>
                        )}
                      </div>
                    ))}
                  </div>
