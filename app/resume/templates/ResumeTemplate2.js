...
const formatDisplayDate = (dateStr) => {
  ...
  if (isNaN(d)) return dateStr; // already plain text ho to wahi return kar do
  const day = d.getDate();
...
export default function ResumeTemplate2({
  ...
  const ContactRow = ({ email, phone, address, website }) => {
    const items = [];
    if (email)
      items.push({ icon: <IconEmail />, text: email, cls: "resume-email" });
    if (phone)
      items.push({ icon: <IconPhone />, text: phone, cls: "resume-phone" });
    if (address)
      items.push({
        icon: <IconLocation />,
        text: address,
    ...
    if (website)
      items.push({ icon: <IconGlobe />, text: website, cls: "resume-website" });
    return (
  ...
  return (
    <div
      ...
      data-selected-resume="ResumeTemplate2"
        ...
        {showStaticData ? (
          <div className={`resume ResumeTemplate2 ${additionalClass}`}>
              ...
              <div className="rt2_skills_grid">
                <ul>
                  {[
                    ...
                    <li key={n}>
                      <span className="rt2_skill_name">{n}</span>
                      <span className="rt2_skill_level">{l}</span>
                    </li>
                  ))}
                </ul>
                <ul>
            ...
            <div className="rt2_section">
              ...
              <div className="rt2_entry">
                <div className="rt2_entry_head">
                  <p className="rt2_entry_title">Retail Sales Associate</p>
                  <p className="rt2_entry_date">Feb 2017 – Present</p>
                </div>
                <EntryMeta parts={["ZARA", "New Delhi, India"]} />
                <ul className="rt2_bullets">
                  <li>
                    Increased monthly sales 10% by effectively upselling and
                    cross-selling products to maximize profitability.
                  </li>
                  <li>
                    Prevented store losses by leveraging awareness, attention to
                    detail, and integrity to identify and investigate concerns.
                  </li>
                  <li>
                    Processed payments and maintained accurate drawers to meet
                    financial targets.
                  </li>
                </ul>
              </div>
              <div className="rt2_entry">
                <div className="rt2_entry_head">
                  <p className="rt2_entry_title">Barista</p>
                  <p className="rt2_entry_date">Mar 2015 – Jan 2017</p>
                </div>
                <EntryMeta parts={["Dunkin' Donuts", "New Delhi, India"]} />
                <ul className="rt2_bullets">
                  <li>
                    Upsold seasonal drinks and pastries, boosting average store
                    sales by ₹1500 weekly.
                  </li>
                  <li>
                    Managed morning rush of over 300 customers daily with
                    efficient, levelheaded customer service.
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="rt2_section">
              ...
              <div className="rt2_entry">
                <div className="rt2_entry_head">
                  <p className="rt2_entry_title">
                    Diploma in Financial Accounting
                  </p>
                  <p className="rt2_entry_date">2016</p>
                </div>
                <EntryMeta
                  parts={["Oxford Software Institute", "New Delhi, India"]}
                />
              </div>
            </div>
                ...
                <div className="rt2_skills_grid">
                  <ul>
                    {skills
                      ...
                      .map((skill, i) => (
                        <li key={i}>
                          <span className="rt2_skill_name">
                            {skill.skill_name}
                          </span>
                          {skill.proficiency_level && (
                            <span className="rt2_skill_level">
                              {skill.proficiency_level}
                            </span>
                          )}
                        </li>
                ...
                {certificates.map((cert, i) => (
                  <div className="rt2_entry" key={i}>
                    ...
                    {cert.issuing_organization && (
                      <EntryMeta parts={[cert.issuing_organization]} />
                    )}
                    {cert.description && (
                      <p className="rt2_text">{cert.description}</p>
                    )}
                  </div>
                ))}
              </div>
              ...
              <div className="rt2_section">
                ...
                <ul className="rt2_plain_list rt2_lang_list">
                  {languages.map((lang, i) => (
                    <li key={i}>
                      <strong>{lang.language}:</strong> {lang.proficiency_level}
                    </li>
                  ))}
                </ul>
              </div>
              ...
              <div className="rt2_section">
                ...
                <ul className="rt2_plain_list rt2_social_list">
                  {social_medias.map((social, i) => {
                    ...
                    return (
                      <li key={i}>
                        <span className="rt2_social_icon">
