...
/* ─── Component ─────────────────────────────────────────────────────────── */
export default function ResumeTemplate6({ additionalClass, isStatic = false, resumeId, isForDownload = false }) {
    ...
    const levelMap = { Beginner: 20, Intermediate: 45, Proficient: 65, Advanced: 80, Expert: 92, Master: 100 };
    ...
    return (
        <div ref={containerRef} className="resume-preview-div" data-selected-resume="ResumeTemplate6"
                        ...
                        <div className="rt6_body">
                            <div className="rt6_left">
                                <div className="rt6_block">
                                    ...
                                    <ul className="rt6_contact_list">
                                        <li><span className="rt6_icon"><IconPhone /></span><span>+91-1234567890</span></li>
                                        <li><span className="rt6_icon"><IconEmail /></span><span>resume@example.com</span></li>
                                        <li><span className="rt6_icon"><IconLocation /></span><span>City, State</span></li>
                                        <li><span className="rt6_icon"><IconGlobe /></span><span>www.example.com</span></li>
                                    </ul>
                                </div>
                                ...
                                <div className="rt6_block">
                                    ...
                                    <ul className="rt6_lang_list">
                                        {[['English', 'Advanced', 90], ['Spanish', 'Intermediate', 55], ['French', 'Beginner', 25]].map(([n, lvl, w]) => (
                                            <li key={n}>
                                                <div className="rt6_lang_top">
                                                    <p>{n}</p>
                                                    <span>{lvl}</span>
                                                </div>
                                                <div className="rt6_bar"><span style={{ width: `${w}%` }} /></div>
                                            </li>
                                        ))}
                                    </ul>
                                </div>
                                ...
                                <div className="rt6_block">
                                    ...
                                    <ul className="rt6_social_list">
                                        {[['Twitter','twitter.com/example'],['LinkedIn','linkedin.com/in/example'],['Instagram','instagram.com/example']].map(([name, url]) => (
                                            <li key={name}>
                                ...
                                <div className="rt6_block">
                                    ...
                                    <div className="rt6_heading_rule" />
                                    <p className="rt6_body_text">Sketching, Photography, Travelling</p>
                                </div>
                            </div>
                            ...
                            <div className="rt6_right">
                                <div className="rt6_block">
                                    ...
                                    <div className="rt6_heading_rule" />
                                    {[
                                        { title: 'Business Administration', org: 'Borcelle University', date: '2027-2030' },
                                        { title: 'Communication', org: 'Borcelle University', date: '2024-2027' },
                                    ].map((e, i) => (
                                        <div className="rt6_entry" key={i}>
                                            <p className="rt6_entry_meta">{e.org} | {e.date}</p>
                                ...
                                <div className="rt6_block">
                                    ...
                                    <div className="rt6_entry">
                                        ...
                                        <p className="rt6_entry_title">Google Analytics Certification</p>
                                        <p className="rt6_entry_desc">Advanced certification covering analytics, reporting and campaign measurement.</p>
                                    </div>
                                </div>
                                ...
                                <div className="rt6_block">
                                    ...
                                    <div className="rt6_heading_rule" />
                                    {[
                                        { title: 'Marketing Executive', org: 'Salford & Co.', date: '2032 - 2035', desc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.' },
                                        { title: 'Digital Marketing Specialist', org: 'Salford & Co.', date: '2030 - 2032', desc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.' },
                                    ].map((e, i) => (
                                        <div className="rt6_entry" key={i}>
                                            <p className="rt6_entry_meta">{e.org} | {e.date}</p>
                                            <p className="rt6_entry_title">{e.title}</p>
                                ...
                                <div className="rt6_block">
                                    ...
                                    <div className="rt6_heading_rule" />
                                    <div className="rt6_entry">
                                        <p className="rt6_entry_meta">CreativeSoft | Jun 2029 - Sep 2029</p>
                    ...
                    <div className={`resume ResumeTemplate6 ${additionalClass}`}>
                        <div className="rt6_header">
                            ...
                            {personalInfomation?.experience && (
                                <p className="rt6_role resume-job-title">{personalInfomation.experience}</p>
                            )}
                            <div className="rt6_rule" />
                        </div>
                        ...
                        {summary?.summary && (
                            <div className="rt6_block rt6_about">
                                <h3 className="rt6_heading">About Me</h3>
                                <p className="rt6_body_text resume-about-me">{summary.summary}</p>
                            </div>
                        )}
                        ...
                        <div className="rt6_body">
                            {/* LEFT */}
                            <div className="rt6_left">
                                {(personalInfomation?.phone || personalInfomation?.email || personalInfomation?.city || personalInfomation?.website) && (
                                    <div className="rt6_block">
                                        <h3 className="rt6_heading">Contact Info</h3>
                                        <div className="rt6_heading_rule" />
                                        <ul className="rt6_contact_list">
                                            {personalInfomation.phone && (
                                                <li><span className="rt6_icon"><IconPhone /></span><span className="resume-phone">{personalInfomation.phone}</span></li>
                                            )}
                                            {personalInfomation.email && (
                                                <li><span className="rt6_icon"><IconEmail /></span><span className="resume-email">{personalInfomation.email}</span></li>
                                            )}
                                            {personalInfomation.city && (
                                                <li><span className="rt6_icon"><IconLocation /></span><span className="resume-address">{[personalInfomation.city, personalInfomation.state].filter(Boolean).join(', ')}</span></li>
                                            )}
                                            {personalInfomation.website && (
                                                <li><span className="rt6_icon"><IconGlobe /></span><span className="resume-website">{personalInfomation.website}</span></li>
                                            )}
                                        </ul>
                                    </div>
                                )}
                                            ...
                                            {languages.map((lang, i) => (
                                                <li key={i}>
                                                    ...
                                                    <div className="rt6_bar">
                                                        <span style={{ width: `${levelMap[lang.proficiency_level] || 60}%` }} />
                                                    </div>
                                                </li>
                                            ))}
                                        </ul>
                                    ...
                                    <div className="rt6_block">
                                        ...
                                        <ul className="rt6_social_list">
                                            {social_medias.map((social, i) => (
                                                <li key={i}>
                                                    <span className="rt6_icon">{getSocialIcon(social.social_name)}</span>
                                ...
                                {hobbies?.length > 0 && (
                                    <div className="rt6_block">
                                        ...
                                        <p className="rt6_body_text">
                                            {hobbies.map((h) => h.hobbies || h).filter(Boolean).join(', ')}
                                        </p>
                                    </div>
                                )}
                            </div>
                                ...
                                {educations?.length > 0 && (
                                    <div className="rt6_block">
                                        ...
                                        {educations.map((edu, i) => (
                                            <div className="rt6_entry" key={i}>
                                                <p className="rt6_entry_meta">{edu.institute_name}{edu.institute_name ? ' | ' : ''}{eduDateLabel(edu)}</p>
                                                <p className="rt6_entry_title">{edu.degree}{edu.field_study ? ` ${edu.field_study}` : ''}</p>
                                            </div>
                                        ))}
                                    </div>
                                )}
                                ...
                                {certificates?.length > 0 && (
                                    <div className="rt6_block">
                                        ...
                                        {certificates.map((cert, i) => (
                                            <div className="rt6_entry" key={i}>
                                                <p className="rt6_entry_meta">{cert.issuing_organization}{cert.issuing_organization ? ' | ' : ''}{cert.issue_date}</p>
                                                <p className="rt6_entry_title">{cert.certificate_name}</p>
                                                {cert.description && <p className="rt6_entry_desc">{cert.description}</p>}
                                            </div>
                                        ))}
                                    </div>
                                )}
                                ...
                                {work_experiences?.length > 0 && (
                                    <div className="rt6_block">
                                        ...
                                        {work_experiences.map((work, i) => (
                                            <div className="rt6_entry" key={i}>
                                                <p className="rt6_entry_meta">{work.company_name}{work.company_name ? ' | ' : ''}{workDateLabel(work)}</p>
                                                <p className="rt6_entry_title">{work.job_title}</p>
                                                {work.description && <p className="rt6_entry_desc">{work.description}</p>}
                                            </div>
                                        ))}
                                    </div>
                                )}
                                ...
                                {any_internships?.length > 0 && (
                                    <div className="rt6_block">
                                        ...
                                        {any_internships.map((intern, i) => (
                                            <div className="rt6_entry" key={i}>
                                                <p className="rt6_entry_meta">{intern.company_name}{intern.company_name ? ' | ' : ''}{workDateLabel(intern)}</p>
