...
export default function UploadResume() {
  ...
  const handleImportResume = async () => {
    ...
    try {
      ...
      router.push(`/bio-data/personal-info/?id=${id}`);
    } catch (error) {
      ...
      <section className='upload-resume-section py-custom'>
        <div className="container-fluid custom-container">
            ...
            <div className="col-lg-6 order-first order-lg-last">
              ...
              >
                ...
                {selectedFile ? (
                  ...
                  <>
                    <label htmlFor="uploadResume" className='fs-mob-16'>upload bio-data</label>
          ...
          <div className='dont-have-resume'>
            ...
            <Link prefetch={false} href='/bio-data/resume-type/'> Create one from scratch
