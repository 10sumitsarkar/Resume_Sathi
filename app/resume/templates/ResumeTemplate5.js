...
export default function ResumeTemplate5({ additionalClass, isStatic = false, resumeId, isForDownload = false }) {
  ...
  const eduDateLabel = (edu) => (!edu.date || !edu.year ? "Still Studying" : `${edu.date} ${edu.year}`);
          ...
          <div className={`resume ResumeTemplate5 ${additionalClass}`}>
            ...
            <div className="rt5_header">
              ...
              <div className="rt5_heading">
                <p className="rt5_name">
                  {staticPersonalInfomation.firstName} {staticPersonalInfomation.lastName}
                </p>
                {staticPersonalInfomation.experience && <p className="rt5_role">{staticPersonalInfomation.experience}</p>}
              </div>
            </div>
            ...
            <div className="rt5_row">
              <div className="rt5_col_label">
                ...
                <ul className="rt5_contact_list">
                  {(staticPersonalInfomation.city || staticPersonalInfomation.state) && (
                    <li><span className="rt5_icon"><IconLocation /></span><span>{[staticPersonalInfomation.city, staticPersonalInfomation.state].filter(Boolean).join(", ")}</span></li>
                  )}
                  {staticPersonalInfomation.phone && (
                    <li><span className="rt5_icon"><IconPhone /></span><span>{staticPersonalInfomation.phone}</span></li>
                  )}
                  {staticPersonalInfomation.email && (
                    <li><span className="rt5_icon"><IconEmail /></span><span>{staticPersonalInfomation.email}</span></li>
                  )}
                  {staticPersonalInfomation.website && (
                    <li><span className="rt5_icon"><IconGlobe /></span><span>{staticPersonalInfomation.website}</span></li>
                  )}
                </ul>
              </div>
            ...
            <div className="rt5_block">
              ...
              <div className="rt5_row">
                ...
                <div className="rt5_col_content">
                  ...
                  <p className="rt5_entry_desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                </div>
              </div>
              <div className="rt5_row">
                <div className="rt5_col_label">
            ...
            <div className="rt5_block">
              ...
              <div className="rt5_row">
                ...
                <div className="rt5_col_content">
                  <p className="rt5_entry_title">Master of Information Management</p>
                </div>
              </div>
              <div className="rt5_row">
                <div className="rt5_col_label">
                ...
                <div className="rt5_col_content">
                  <p className="rt5_entry_title">Bachelor of Information Management</p>
                </div>
              </div>
            </div>
            ...
            <div className="rt5_block">
              ...
              <div className="rt5_row">
                ...
                <div className="rt5_col_content">
                  <p className="rt5_entry_title">Data Analytics Professional Certificate</p>
                </div>
              </div>
            </div>
            ...
            <div className="rt5_block">
              ...
              <ul className="rt5_skill_list">
                {[
                  ...
                  <li key={name}>
                    <p>{name} <span className="rt5_skill_level">{level}</span></p>
                    <div className="rt5_bar"><span style={{ width: `${levelMap[level] || 70}%` }} /></div>
                  </li>
                ))}
              </ul>
            </div>
          ...
          <div className={`resume ResumeTemplate5 ${additionalClass}`}>
            ...
            <div className="rt5_header">
              <div className="rt5_photo">
                <img
                  loading="lazy"
                  src={personalInfomation.photo || "/front-assets/images/icons/user-icon.svg"}
              ...
              <div className="rt5_heading">
                ...
                {personalInfomation.experience && <p className="rt5_role">{personalInfomation.experience}</p>}
              </div>
            </div>
              ...
              <div className="rt5_col_label">
                ...
                <ul className="rt5_contact_list">
                  {(personalInfomation.city || personalInfomation.state) && (
                    <li><span className="rt5_icon"><IconLocation /></span><span>{[personalInfomation.city, personalInfomation.state].filter(Boolean).join(", ")}</span></li>
                  )}
                  {personalInfomation.phone && (
                    <li><span className="rt5_icon"><IconPhone /></span><span>{personalInfomation.phone}</span></li>
                  )}
                  {personalInfomation.email && (
                    <li><span className="rt5_icon"><IconEmail /></span><span>{personalInfomation.email}</span></li>
                  )}
                  {personalInfomation.website && (
                    <li><span className="rt5_icon"><IconGlobe /></span><span>{personalInfomation.website}</span></li>
                  )}
                ...
                {work_experiences.map((work, index) => (
                  <div className="rt5_row" key={index}>
                    ...
                    <div className="rt5_col_content">
                      ...
                      <p className="rt5_entry_sub">{work.location}{work.employee_type ? ` • ${work.employee_type}` : ""}</p>
                      {work.description && <p className="rt5_entry_desc">{work.description}</p>}
                    </div>
                  </div>
                ))}
              </div>
                  ...
                  <div className="rt5_row" key={index}>
                    <div className="rt5_col_label">
                      <p className="rt5_entry_date">
                        {intern.start_month} {intern.start_year} - {(!intern.end_month || !intern.end_year) ? "Present" : `${intern.end_month} ${intern.end_year}`}
                      </p>
                      <p className="rt5_entry_org">{intern.company_name}</p>
                    </div>
                    <div className="rt5_col_content">
                      <p className="rt5_entry_title">{intern.job_title}</p>
                      <p className="rt5_entry_sub">{intern.location}{intern.employee_type ? ` • ${intern.employee_type}` : ""}</p>
                    </div>
                  </div>
                ))}
              </div>
                  ...
                  <div className="rt5_row" key={index}>
                    ...
                    <div className="rt5_col_content">
                      <p className="rt5_entry_title">
                        {edu.degree}{edu.field_study ? ` - ${edu.field_study}` : ""}
                      </p>
                      {edu.location && <p className="rt5_entry_desc">{edu.location}</p>}
                    </div>
                  </div>
                ))}
              </div>
            ...
            {certificates?.length > 0 && (
              <div className="rt5_block">
                ...
                {certificates.map((cert, index) => (
                  <div className="rt5_row" key={index}>
                    <div className="rt5_col_label">
                      {cert.issue_date && <p className="rt5_entry_date">{cert.issue_date}</p>}
                      {cert.issuing_organization && <p className="rt5_entry_org">{cert.issuing_organization}</p>}
                    </div>
                    <div className="rt5_col_content">
                      <p className="rt5_entry_title">{cert.certificate_name}</p>
                      {cert.description && <p className="rt5_entry_desc">{cert.description}</p>}
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="rt5_block">
                ...
                <ul className="rt5_skills_grid">
                  {skills.map((skill, index) => (
                    <li key={index}>
                      <p>{skill.skill_name} <span className="rt5_skill_level">({skill.proficiency_level})</span></p>
              ...
              <div className="rt5_block">
                ...
                <ul className="rt5_skills_grid">
                  {languages.map((lang, index) => (
                    <li key={index}>{lang.language} — {lang.proficiency_level}</li>
                  ))}
                </ul>
              </div>
            )}
              ...
              <div className="rt5_block">
                ...
                <ul className="rt5_social_grid">
                  {social_medias?.map((social, index) => {
                    ...
                    return (
                      <li key={index}>
                        <span className="rt5_icon">{getSocialIcon(social.social_name)}</span>
                        <div><span>{social.social_name} -</span><a href={url} target="_blank" rel="noopener noreferrer">{url}</a></div>
                      </li>
                    );
                  })}
