...
const id = searchParams.get('id');
  ...
  const nextButton = () => {
    ...
    setTimeout(() => {
      setLoading(false);
      router.push(`/bio-data/hobbie/?id=${id}`);
    }, 2500);
  };
  return (
    <>
...
<path d="M15 0H1C0.45 0 0 0.45 0 1C0 1.55 0.45 2 1 2H15C15.55 2 16 1.55 16 1C16 0.45 15.55 0 15 0ZM1 6H15C15.55 6 16 5.55 16 5C16 4.45 15.55 4 15 4H1C0.45 4 0 4.45 0 5C0 5.55 0.45 6 1 6Z" fill="black"/>
            ...
            <div className={`row ${formOpened === true ? "" : "d-none"}`}>
              ...
              <div className="col-md-6 col-lg-12 col-xl-6 mb-4">
                <div className="each-input-div">
                  <label htmlFor="job_title">Work / Job Title<span className='text-danger'>*</span></label>
                  <input
                    type="text"
                    {...register("job_title", {
              ...
              <div className="col-md-6 col-lg-12 col-xl-6 mb-4">
                <div className="each-input-div">
                  <label htmlFor="company_name">Company / Organization<span className='text-danger'>*</span></label>
                  <input
                    type="text"
              ...
              <div className="col-md-6 col-lg-12 col-xl-6 mb-4">
                <div className="each-input-div">
                  <label htmlFor="employee_type">Employment Type<span className='text-danger'>*</span></label>
                  <CustomInput
                    type="select"
                    register={register}
              ...
              <div className="col-12 col-lg-12 col-xl-12 col-xxl-6 mb-4">
                <div className="each-input-div">
                  <label htmlFor="end_month">End Date<span className='text-danger'>*</span></label>
                </div>
                <div className="row">
                  <div className="col-6">
                    <div className="each-input-div">
        ...
        <div className="next-prev-btn-div d-none d-lg-flex">
          ...
          <button type="button" onClick={nextButton} className="next-btn">
            {work_experiences.length >= 1 ? "Next" : "Skip & Next"}
          </button>
        </div>
