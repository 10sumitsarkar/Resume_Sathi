...
const id = searchParams.get('id');
  ...
  const handleCloseAndNavigate = () => {
    ...
    router.push(`/bio-data/preview/?id=${id}`);
  };
        ...
        <form onSubmit={handleSubmit(onSubmit)} ref={formRef}>
          <div className="container-fluid px-0  pb-5 pb-md-0 my-5 mb-md-0">
            ...
            <div className={`row ${formOpened === true ? '' : 'd-none'}`}>
              ...
              <div className="col-md-6 col-lg-12 col-xl-6 mb-4">
                <div className='each-input-div'>
                  <label htmlFor="hobbies">Hobby / Interest<span className='text-danger'>*</span></label>
                  <input
                    type="text"
                    {...register("hobbies", {
                      ...
                      pattern: {
                        value: /^[A-Za-z\s,.'-]+$/,
                        message: "Only letters and commas are allowed",
                      },
                    })}
            ...
            <button type='button' className={`add-more-btn ${formOpened === true ? 'd-none' : ''}`} onClick={AddMoreHobbie}>
              <img src="/front-assets/images/icons/add-more.svg" alt="Add More" /> Add More Hobby / Interest
            </button>
          </div >
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-body py-4">
              ...
              <h5 className='heading'>Your Bio-Data is Ready!</h5>
              <p className='sub-heading'>Your bio-data is ready for preview.</p>
